...
public class DeptEmplyee1 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Would you like to see sum of professors and secreatrys's salary? (Y/N) \n");
		...
		if(s.next().equalsIgnoreCase("Y"))
		{
			...
			System.out.println("Sum both professors and Secretarys:"+(sum1 + sum2));
		}
	}

}
/**
Would you like to see sum of professors and secreatrys's salary? (Y/N) 
y
sum of professors salary is: 3800.0
sum of secretarys salary is: 1650.0
Sum both professors and Secretarys:5450.0
 */
